...
import com.example.tabloginregister.databinding.FragmentLoginBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            buttonReg.setOnClickListener {
                val inputUsername = usernameContentField.text.toString()
                val inputPassword = passwordContentField.text.toString()
